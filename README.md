...
<img src='http://i.imgur.com/aepxBLK.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [Peek](https://github.com/phw/peek/releases).

## Notes

The biggest challenge involved linking between the states and territories pages since they shared a state id.
